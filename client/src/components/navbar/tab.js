            ...
            tab_title = (
                <div className="editMode">
                         <input 
                             ...
                             value={tabName}
                             />
                <button type="button" className={`btn edit-mode-btn green accent-4 ${editable ? 'visible' : 'hidden'}`} onClick={(event)=>this.notEditTabs(event)}>
                <i className="small material-icons">check</i></button>
                 
                <button type="button" className={`btn edit-mode-btn red accent-4 ${editable ? 'visible' : 'hidden'}`} onClick={(event)=>this.cancelTabEdit(event)}>
